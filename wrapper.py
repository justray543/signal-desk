...
class IBWrapper(EWrapper):
    ...
    def openOrder(self, order_id, contract, order, order_state):
        ...
        pending_statuses = ["PreSubmitted", "Submitted", "PendingSubmit", "ApiPending"]
        if order_state.status in pending_statuses:
    ...
    def tickByTickBidAsk(
        self, request_id, time, bid_price, ask_price,
        bid_size, ask_size, tick_atrrib_last
    ):
    ...
    def updatePortfolio(
        self, contract, position, market_price, market_value,
